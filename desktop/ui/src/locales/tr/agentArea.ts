...
export const agentArea: AgentAreaDict = {
  perf: {
    ...
    detail: {
      title: "Analiz — {date}",
      tabSummary: "Özet",
      legacyNotice: "Bu analiz, düzeltmeden önceki eski bir çalıştırmadan sonradan ayrıştırıldı. Önerilen değişiklikler hiç uygulanmadı — yalnızca analiz metni kurtarılabildi.",
      noDecision: "Bu analiz için yapılandırılmış bir sonuç yok; aşağıda ham özet gösteriliyor.",
      compareHeading: "Önce → Sonra",
      compareRow: {
        score: "Performans skoru",
        kpiComposite: "KPI bileşik skoru",
        goldenPassRate: "Golden geçiş oranı",
        skills: "Skill",
        rules: "Kural",
        memories: "Hafıza",
      },
      ...
      colAfter: "Sonra",
      colDelta: "Delta",
      budgetSuffix: "/ {budget} bütçe",
      decisionsHeading: "Kararlar",
      decisionsEmpty: "Değişiklik önerilmedi.",
      reasonLabel: "Gerekçe:",
      detailLabel: "Detay:",
      showContentDiff: "Önce/sonra içeriğini göster",
      hideContentDiff: "Önce/sonra içeriğini gizle",
      noEvolutionEvent: "Bağlı değişiklik kaydı yok.",
      gateHeading: "Golden gate",
      gateKept: "korundu",
      gateRolledBack: "geri alındı ({count})",
      gateReasonLabel: "Gerekçe:",
      analysisHeading: "Analiz",
      rawOutputHeading: "Ham çıktı",
      outcome: {
        applied: "uygulandı",
        rejected: "reddedildi",
        skipped: "atlandı",
      ...
      kind: {
        skill_create: "Skill eklendi",
        skill_update: "Skill güncellendi",
        skill_delete: "Skill silindi",
        rule_create: "Kural eklendi",
        rule_update: "Kural güncellendi",
        rule_delete: "Kural silindi",
        memory_create: "Hafıza eklendi",
        memory_update: "Hafıza güncellendi",
        memory_delete: "Hafıza silindi",
        revert_revert: "Geri alındı",
      },
    },
    timeline: {
    ...
    reflections: {
      heading: "Analiz Geçmişi",
      empty: "Henüz analiz yapılmadı.",
      statusCompleted: "tamamlandı",
      statusFailed: "başarısız",
      statusRunning: "çalışıyor",
      appliedCount: "{count} uygulandı",
      notAppliedCount: "{count} uygulanmadı",
      legacyBadge: "eski",
